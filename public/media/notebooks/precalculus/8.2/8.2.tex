...
In order to avoid redundancy, only content from after the midterm will be included. See the the midterm review for content before the review: \url{https://tamath.org/media/notebooks/precalculus/7.17/7.17.pdf}.\\
